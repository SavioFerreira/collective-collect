    ...
    <VStack flex={1}>
      ...
      {isLoading ? <Loading /> :
        <View flex={1} m={3}>
          ...
          <HStack mt={3} flex={1} rounded="lg" bgColor="rgba(255, 0, 0, 0.5)" justifyContent="space-around">
            <Text color="white" textAlign="center" fontFamily='body' fontSize="md" m={4}>
              Selecione alguma coleta para visualizar
            </Text>
          </HStack>
        </View>
      }
